...
def import_full_staff_v6():
    ...
    try:
        ...
        RANGE_SCENE = (101, 200)
        RANGE_HOBBY = (201, 999)
        RANGE_OVERFLOW = (1000, 9999) # For verification, just in case
        ...
        tag_map = {} # Empty since we wiped DB
